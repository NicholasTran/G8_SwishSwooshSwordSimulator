...
--               C:/Users/Sam/Desktop/ECE532/mid_demo_v6_timer_gtracker/mid_demo/mid_demo.srcs/sources_1/bd/mid_project/ip/mid_project_kb_slave_0_0/mid_project_kb_slave_0_0_sim_netlist.vhdl
...
entity mid_project_kb_slave_0_0_debouncer is
  port (
    O0 : out STD_LOGIC;
    O1_reg_0 : out STD_LOGIC;
    CLK50MHZ : in STD_LOGIC;
    PS2_THING : in STD_LOGIC;
    PS2_DATA : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mid_project_kb_slave_0_0_debouncer : entity is "debouncer";
end mid_project_kb_slave_0_0_debouncer;

architecture STRUCTURE of mid_project_kb_slave_0_0_debouncer is
  ...
  attribute SOFT_HLUTNM of \cnt0[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cnt0[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cnt1[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cnt1[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cnt1[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cnt1[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cnt1[4]_i_3\ : label is "soft_lutpair4";
begin
  O0 <= \^o0\;
  O1_reg_0 <= \^o1_reg_0\;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mid_project_kb_slave_0_0_kb_slave_v1_0_S00_AXI is
  port (
    ...
    \slv_reg2_reg[3]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mid_project_kb_slave_0_0_kb_slave_v1_0_S00_AXI : entity is "kb_slave_v1_0_S00_AXI";
end mid_project_kb_slave_0_0_kb_slave_v1_0_S00_AXI;

architecture STRUCTURE of mid_project_kb_slave_0_0_kb_slave_v1_0_S00_AXI is
  ...
  signal axi_awaddr : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  signal \^slv_reg2_reg[3]_0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
...
begin
  ...
  \slv_reg2_reg[3]_0\(3 downto 0) <= \^slv_reg2_reg[3]_0\(3 downto 0);
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mid_project_kb_slave_0_0_seg7decimal is
  port (
    \clkdiv_reg[18]_0\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    ...
    \digit_reg[3]_1\ : in STD_LOGIC;
    \digit_reg[2]_0\ : in STD_LOGIC;
    \digit_reg[1]_0\ : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mid_project_kb_slave_0_0_seg7decimal : entity is "seg7decimal";
end mid_project_kb_slave_0_0_seg7decimal;

architecture STRUCTURE of mid_project_kb_slave_0_0_seg7decimal is
  ...
  signal \^clkdiv_reg[18]_0\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \AN[0]_INST_0\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \AN[1]_INST_0\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \AN[2]_INST_0\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \AN[3]_INST_0\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \AN[4]_INST_0\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of \SEG[2]_INST_0\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \SEG[3]_INST_0\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \SEG[4]_INST_0\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \SEG[6]_INST_0\ : label is "soft_lutpair25";
begin
  \clkdiv_reg[18]_0\(1 downto 0) <= \^clkdiv_reg[18]_0\(1 downto 0);
...
\clkdiv_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => s(2),
      S(2 downto 1) => \^clkdiv_reg[18]_0\(1 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mid_project_kb_slave_0_0_PS2Receiver is
  port (
    D : out STD_LOGIC_VECTOR ( 31 downto 0 );
    \keycode_reg[12]_0\ : out STD_LOGIC;
    \keycode_reg[13]_0\ : out STD_LOGIC;
    \keycode_reg[14]_0\ : out STD_LOGIC;
    \keycode_reg[15]_0\ : out STD_LOGIC;
    CLK50MHZ : in STD_LOGIC;
    PS2_THING : in STD_LOGIC;
    PS2_DATA : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mid_project_kb_slave_0_0_PS2Receiver : entity is "PS2Receiver";
end mid_project_kb_slave_0_0_PS2Receiver;

architecture STRUCTURE of mid_project_kb_slave_0_0_PS2Receiver is
  signal O0 : STD_LOGIC;
  ...
  signal \keycode_reg_n_0_[0]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[16]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[17]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[18]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[19]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[1]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[20]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[21]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[22]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[23]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[24]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[25]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[26]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[27]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[28]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[29]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[2]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[30]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[31]\ : STD_LOGIC;
  signal \keycode_reg_n_0_[3]\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  ...
  attribute SOFT_HLUTNM of \slv_reg0[10]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \slv_reg0[11]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \slv_reg0[12]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \slv_reg0[17]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \slv_reg0[18]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \slv_reg0[19]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \slv_reg0[1]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \slv_reg0[20]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \slv_reg0[21]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \slv_reg0[22]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \slv_reg0[23]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \slv_reg0[24]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \slv_reg0[27]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \slv_reg0[28]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \slv_reg0[29]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \slv_reg0[2]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \slv_reg0[30]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \slv_reg0[31]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \slv_reg0[3]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \slv_reg0[4]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \slv_reg0[5]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \slv_reg0[6]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \slv_reg0[7]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \slv_reg0[8]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \slv_reg0[9]_i_1\ : label is "soft_lutpair21";
begin
...
debounce: entity work.mid_project_kb_slave_0_0_debouncer
     port map (
      CLK50MHZ => CLK50MHZ,
      O0 => O0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mid_project_kb_slave_0_0_kb_slave_v1_0 is
  port (
    AN : out STD_LOGIC_VECTOR ( 7 downto 0 );
    s00_axi_awready : out STD_LOGIC;
    s00_axi_wready : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mid_project_kb_slave_0_0_kb_slave_v1_0 : entity is "kb_slave_v1_0";
end mid_project_kb_slave_0_0_kb_slave_v1_0;

architecture STRUCTURE of mid_project_kb_slave_0_0_kb_slave_v1_0 is
...
kb_slave_v1_0_S00_AXI_inst: entity work.mid_project_kb_slave_0_0_kb_slave_v1_0_S00_AXI
     port map (
      D(31 downto 0) => p_2_in(31 downto 0),
      Q(3 downto 0) => slv_reg3(3 downto 0),
      \axi_awaddr_reg[2]_0\(0) => axi_awaddr(2),
      ...
      \slv_reg2_reg[3]_0\(3 downto 0) => slv_reg2(3 downto 0)
    );
keyboard: entity work.mid_project_kb_slave_0_0_PS2Receiver
     port map (
      CLK50MHZ => CLK50MHZ,
      D(31 downto 0) => p_2_in(31 downto 0),
      PS2_DATA => PS2_DATA,
      ...
      \slv_reg0_reg[31]\(0) => axi_awaddr(2)
    );
sevenSeg: entity work.mid_project_kb_slave_0_0_seg7decimal
     port map (
      AN(7 downto 0) => AN(7 downto 0),
      Q(3 downto 0) => slv_reg3(3 downto 0),
      SEG(6 downto 0) => SEG(6 downto 0),
      \clkdiv_reg[18]_0\(1 downto 0) => s(1 downto 0),
      \digit_reg[0]_0\ => keyboard_n_32,
      \digit_reg[1]_0\ => keyboard_n_33,
      \digit_reg[2]_0\ => keyboard_n_34,
      \digit_reg[3]_0\(3 downto 0) => slv_reg2(3 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mid_project_kb_slave_0_0 is
  port (
    PS2_THING : in STD_LOGIC;
    PS2_DATA : in STD_LOGIC;
    SEG : out STD_LOGIC_VECTOR ( 6 downto 0 );
  ...
  attribute NotValidForBitStream of mid_project_kb_slave_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of mid_project_kb_slave_0_0 : entity is "mid_project_kb_slave_0_0,kb_slave_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of mid_project_kb_slave_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of mid_project_kb_slave_0_0 : entity is "kb_slave_v1_0,Vivado 2018.3";
end mid_project_kb_slave_0_0;

architecture STRUCTURE of mid_project_kb_slave_0_0 is
...
inst: entity work.mid_project_kb_slave_0_0_kb_slave_v1_0
     port map (
      AN(7 downto 0) => AN(7 downto 0),
      PS2_DATA => PS2_DATA,
      PS2_THING => PS2_THING,
