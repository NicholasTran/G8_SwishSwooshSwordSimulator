...
HD_PWD='C:/Users/Sam/Desktop/ECE532/mid_demo_v2/mid_demo/mid_demo.runs/mid_project_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mid_project_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mid_project_xbar_0.tcl
