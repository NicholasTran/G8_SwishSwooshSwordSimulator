...
HD_PWD='C:/Users/Sam/Desktop/ECE532/mid_demo_v6_timer_gtracker/mid_demo/mid_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mid_project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mid_project_wrapper.tcl -notrace
