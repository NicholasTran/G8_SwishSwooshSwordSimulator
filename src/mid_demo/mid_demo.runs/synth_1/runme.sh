...
HD_PWD='C:/Users/Sam/Desktop/ECE532/mid_demo_v6_timer_gtracker/mid_demo/mid_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mid_project_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mid_project_wrapper.tcl
