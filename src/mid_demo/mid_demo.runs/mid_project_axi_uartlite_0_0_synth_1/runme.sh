...
HD_PWD='D:/ece532/mid_demo/mid_demo/mid_demo.runs/mid_project_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mid_project_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mid_project_axi_uartlite_0_0.tcl
